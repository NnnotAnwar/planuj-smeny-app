...
export default function ShiftCards({ locationName, shifts, userShift }: ShiftCardsProps) {
  ...
  return (
    <motion.div 
      ...
      className="rounded-xl bg-white/40 dark:bg-white/5 backdrop-blur-md p-0 md:p-4 border border-emerald-500/10 dark:border-white/5 transition-all overflow-hidden shadow-xl shadow-emerald-500/5"
    >
      <h3 className="mb-2 flex items-center justify-between rounded-lg bg-gray-800 dark:bg-gray-800/90 px-3 py-1.5 text-sm font-semibold text-white border border-gray-700 dark:border-gray-600 shadow-md">
