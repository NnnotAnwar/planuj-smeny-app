 ...
 * Shows a grid of clickable location buttons. 
 * Supports showing all locations or a limited view with a "Show All" toggle.
 */
...
export function LocationSelection({
  ...
  // 1. Calculate which locations to display.
    ...
    <div className="w-full">
      ...
      >
        <AnimatePresence mode="popLayout">
          ...
          {/* Special case: If the active location is hidden (truncated), force it to show. */}
...
/**
 * Sub-component for a single location button.
 */
